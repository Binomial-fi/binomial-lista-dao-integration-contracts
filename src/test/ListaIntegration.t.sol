...
import {ListaIntegrationV2} from "../contracts/mocks/ListaIntegrationV2.sol";
...
contract ListaIntegrationTest is Test {
    ...
    function testUpgradeability() public {
        ...
        // Deploy StakeListaV2
        ListaIntegrationV2 stake_lista_contract_v2_implementation = new ListaIntegrationV2();

        bytes memory data = bytes("");

        proxyAdmin.upgradeAndCall(
            ITransparentUpgradeableProxy(address(proxy)), address(stake_lista_contract_v2_implementation), data
        );
    ...
    //     vm.prank(user1);
    //     console.log("user1 balance before claim: ", user1.balance);
    //     stake_lista_contract.claimRewards();
